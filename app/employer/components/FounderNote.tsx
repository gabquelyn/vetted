...
export default function FounderNote() {
  return (
    <section className="border-y border-ash bg-white px-6 md:px-12 py-8">
      <div className="mx-auto flex md:max-w-5xl flex-col gap-6 md:flex-row md:items-center md:justify-between">
        ...
        <motion.p
          ...
          className="md:max-w-2xl text-sm leading-relaxed text-ink-soft"
        >
